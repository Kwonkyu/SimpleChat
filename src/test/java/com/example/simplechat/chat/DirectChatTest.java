...
class DirectChatTest {
	...
	void init() {
		...
		directChatService.sendChat(USER1USERNAME, USER2USERNAME, CHAT_FROM_USER1_TO_USER2);
		directChatService.sendChat(USER2USERNAME, USER1USERNAME, CHAT_FROM_USER2_TO_USER1);
		directChatService.sendChat(USER2USERNAME, USER1USERNAME, CHAT_FROM_USER2_TO_USER1);
		directChatService.sendChat(USER1USERNAME, USER2USERNAME, CHAT_FROM_USER1_TO_USER2);
		directChatService.sendChat(USER3USERNAME, USER1USERNAME, CHAT_FROM_USER3_TO_USER1);
		directChatService.sendChat(USER3USERNAME, USER1USERNAME, CHAT_FROM_USER3_TO_USER1);
		directChatService.sendChat(USER3USERNAME, USER1USERNAME, CHAT_FROM_USER3_TO_USER1_LATEST);
	}
